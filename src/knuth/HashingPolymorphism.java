 ...
 * @author luism
 */
public class HashingPolymorphism {

    private static final Logger LOG = Logger.getLogger(HashingPolymorphism.class.getName());
    
    //public Object[] data;
    
    public HashingPolymorphism() {
    }

    public boolean isNumeroNatural(int numeroNatural) {
